...
import static com.ba.boost.exception.ErrorType.BAD_REQUEST_ERROR;
import static com.ba.boost.exception.ErrorType.INTERNAL_ERROR;

@ControllerAdvice
public class GlobalExceptionHandler {

    /**
     * Genel hatalar burada yakalanacak
     * @param exception
     * @return
     */
    ...
    /**
     * AutService ile ilgili hatalar burada yakalanacak.
     * @param exception
     * @return
     */
    ...
    /**
     * Spring, kullandıgımız veritabanı, üçüncü parti eklentilerden gelen hatalar aşağıda
     * createErrorMessage methoduna kadar olan kısımda yakalanacak.
     * @param exception
     * @return
     */
...
*/
    ...
    /**
     * Hata yakalama işlemleri bir çok hata için ayrı ayrı yapılmalıdır.
     * Bu nedenle tüm hataların içerisine log alma işlemi yazmak zorunda kalırız.
     * Bu işlemleri tekelleştirmek ve hata log kayıtlarını toplamak için tek bir method kullanmak daha doğru olacaktır.
     * @param exception
     * @param errorType
     * @return
     */
